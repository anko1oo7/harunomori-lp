        ...
        <div className="space-y-12 reveal" style={{ animationDelay: "0.1s" }}>
          ...
          <section className="glass rounded-[40px] p-8 md:p-12">
            ...
            <div className="space-y-8 text-[var(--ink-soft)] leading-relaxed">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-bold text-[var(--ink)]">第2条（納品物の利用範囲と権利について）</h3>
                <p>
                  1. 依頼者様は、代金の完納後、納品物をYouTube、SNS、配信プラットフォーム、告知、ライブ演出等、事前に合意した範囲で利用できます。
                </p>
                <p>
                  2. 本サービスでは制作工程の一部に生成AIを使用します。AI生成部分を含む納品物の著作物性や権利範囲は、制作過程や人の創作的寄与など、個別事情により判断されます。
                </p>
                <p>
                  3. 制作者は、制作者が有する権利の範囲において、依頼者様に納品物の利用を許諾します。
                </p>
                <p>
                  4. 制作者は、制作物の制作実績として、ポートフォリオ、SNS、note等で公開する場合があります。ただし、実績公開不可のオプションを選択された場合、または別途合意した場合はこの限りではありません。
                </p>
              </div>

              <div className="space-y-4">
                <h3 className="text-lg font-bold text-[var(--ink)]">第3条（提供素材の権利確認）</h3>
                <p>
                  1. 依頼者様は、提供する楽曲、歌詞、キャラクターデザイン、画像、ロゴ、その他素材について、動画制作、AI生成補助、編集、公開、商用利用に必要な権利または許諾を有していることを保証するものとします。
                </p>
                <p>
                  2. 権利者の許諾が確認できない素材、ファンアート、二次創作イラスト、拾い画像、第三者の著作物を含む素材は、使用できない場合があります。
                </p>
                <p>
                  3. 依頼者様が提供した素材、または依頼者様の指定・要望に起因して発生した権利上の問題については、依頼者様の責任において対応いただきます。
                </p>
              </div>

              <div className="space-y-4">
                <h3 className="text-lg font-bold text-[var(--ink)]">第4条（既存作品の再現・模倣について）</h3>
                <p>
                  1. 本サービスでは、既存のMV、アニメ、映画、イラスト、ゲーム、キャラクター、特定クリエイターの表現を再現・模倣する目的での制作は行いません。
                </p>
                <p>
                  2. 参考資料は、色味、テンポ感、空気感、感情の方向性、世界観などを把握するために使用します。具体的な構図、キャラクターデザイン、画面構成、演出の流れをそのまま再現することはできません。
                </p>
                <p>
                  3. 制作者は、納品前に可能な範囲で既存著作物との類似性や権利上の問題がないか確認します。ただし、すべての既存著作物との非類似性や、第三者から権利主張を受けないことを保証するものではありません。
                </p>
              </div>

              <div className="space-y-4">
                <h3 className="text-lg font-bold text-[var(--ink)]">第5条（キャンセル・修正）</h3>
                <p>
